      ...
      <main className="px-3 lg:px-6 py-3 lg:py-6 space-y-5 lg:space-y-10 pb-24 lg:pb-8 w-full max-w-md lg:max-w-none mx-auto lg:mx-0">
        ...
        <section className="home-section">
          ...
          {loading ? <FastLoadingSkeleton type="cards" count={3} /> : meetupEvents.length === 0 ? <div className="text-center py-6 text-muted-foreground">
            ...
            </div> : <div className="flex overflow-x-auto gap-4 pb-3 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40" dir="ltr" style={{
          scrollBehavior: 'smooth'
        }}>
        ...
        <section className="home-section">
          ...
          <div className="flex overflow-x-auto gap-4 pb-3 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground/20 hover:scrollbar-thumb-muted-foreground/40" dir="ltr" style={{
          scrollBehavior: 'smooth'
        }}>
