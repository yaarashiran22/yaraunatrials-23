        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-3 transform translate-y-0 group-hover:translate-y-[-2px] transition-transform duration-300">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5 mt-1">
              {date && (
                <span className="text-xs font-medium px-2 py-0.5 bg-white backdrop-blur-md rounded-full text-black border border-gray-200 shadow-lg transition-all duration-300 group-hover:bg-gray-50 group-hover:scale-105">{date}</span>
              )}
              {(price || (type === 'event')) && (
