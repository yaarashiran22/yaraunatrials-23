...
import { Coffee, Zap, Heart, Dumbbell, Palette, Users, Leaf, Search, X, MapPin, Calendar, User, Building, ShoppingBag, Music, UtensilsCrossed } from "lucide-react";
...
const moodFilters = [
  ...
  { id: "hungry", label: "Hungry", icon: UtensilsCrossed, color: "text-amber-500", activeBg: "bg-amber-50 dark:bg-amber-950/30" }
];
