  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const {
        ...
        // Using title as description for buzz
        image_url: imageUrl,
      ...
      <DialogContent className="max-w-2xl w-full max-h-[90vh] overflow-y-auto z-[9999]">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-muted/50 rounded-lg p-4">
            {userLocation ? <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="title" placeholder="What's popping?" value={title} onChange={e => setTitle(e.target.value)} />
            </div>
            ...
            <div>
              ...
              <div className="mt-1">
                ...
                <Button variant="outline" onClick={() => document.getElementById('photo')?.click()} className="w-full">
          ...
          <div className="flex gap-2 pt-4 border-t">
            <Button onClick={handleSubmit} disabled={isSubmitting || !title.trim() || !userLocation} className="flex-1">
