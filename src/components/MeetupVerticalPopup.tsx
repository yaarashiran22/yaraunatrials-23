          ...
          <div className="space-y-4">
            {joinStatus === 'approved' ? (
              ...
              <Button 
                ...
                className="w-full h-12 bg-red-400 hover:bg-red-500 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
