...
const BottomNavigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-card/95 via-card/98 to-card/95 backdrop-blur-xl border-t-2 border-primary/20 lg:hidden shadow-large safe-area-inset-bottom artistic-texture">
