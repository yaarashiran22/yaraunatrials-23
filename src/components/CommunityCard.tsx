...
const CommunityCard = ({ community, onClick, onUpdate, onDelete }: CommunityCardProps) => {
  ...
  return (
    ...
    >
      {/* Cover Image */}
      <div className="h-48 bg-gradient-to-r from-primary/10 to-primary/20 relative overflow-hidden">
        ...
        <div className="absolute -bottom-14 left-4">
          <div className="w-24 h-24 bg-white rounded-lg border-2 border-white shadow-sm flex items-center justify-center overflow-hidden">
            {community.logo_url ? (
              <img 
